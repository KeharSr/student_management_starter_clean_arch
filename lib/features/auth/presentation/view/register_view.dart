...
class _RegisterViewState extends ConsumerState<RegisterView> {
  ...
  final _fnameController = TextEditingController(text: 'kehar');
  final _lnameController = TextEditingController(text: 'ojha');
  final _phoneController = TextEditingController(text: '989898989898');
  final _usernameController = TextEditingController(text: 'kehar');
